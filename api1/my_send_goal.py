...
def movebase_client(local):
    ...
    if local == "LE-1":
        ...
        goal.target_pose.pose.position.w = 0
    elif local == "LE-2":
...
if __name__ == '__main__':
    try:
        ...
        local = input("Qual local quer ir ?")

        result = movebase_client(local)
        rospy.loginfo("Going to chosen location!")
        rospy.sleep(10)
        ...
        rospy.loginfo("Navgation finished.")